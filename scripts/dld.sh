...
raw_result=$(curl -s "https://filelist.io/api.php?username=$FL_USERNAME&passkey=$PASSKEY&action=search-torrents&type=name&category=19,4,6,26,21,27,20,2,3&query=$movieName")
